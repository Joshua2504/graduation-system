...
$translations = [
    ...
    // Shared Files
    'files' => ['ar' => 'الملفات', 'en' => 'Files', 'de' => 'Dateien'],
    'files_count' => ['ar' => 'ملف', 'en' => 'files', 'de' => 'Dateien'],
    'add_file' => ['ar' => 'إضافة ملف', 'en' => 'Add File', 'de' => 'Datei hinzufügen'],
    'add_new_file' => ['ar' => 'إضافة ملف جديد', 'en' => 'Add New File', 'de' => 'Neue Datei hinzufügen'],
    'edit_file' => ['ar' => 'تعديل الملف', 'en' => 'Edit File', 'de' => 'Datei bearbeiten'],
    'delete_file' => ['ar' => 'حذف الملف', 'en' => 'Delete File', 'de' => 'Datei löschen'],
    'no_files' => ['ar' => 'لا توجد ملفات مرفوعة', 'en' => 'No files uploaded', 'de' => 'Keine Dateien hochgeladen'],
    'file_name' => ['ar' => 'اسم الملف', 'en' => 'File Name', 'de' => 'Dateiname'],
    'file_note' => ['ar' => 'ملاحظات', 'en' => 'Notes', 'de' => 'Anmerkungen'],
    'file_upload' => ['ar' => 'الملف', 'en' => 'File', 'de' => 'Datei'],
    'download_file' => ['ar' => 'تحميل الملف', 'en' => 'Download File', 'de' => 'Datei herunterladen'],
    'file_created' => ['ar' => 'تم رفع الملف بنجاح', 'en' => 'File uploaded successfully', 'de' => 'Datei erfolgreich hochgeladen'],
    'file_updated' => ['ar' => 'تم تعديل الملف بنجاح', 'en' => 'File updated successfully', 'de' => 'Datei erfolgreich aktualisiert'],
    'file_deleted' => ['ar' => 'تم حذف الملف بنجاح', 'en' => 'File deleted successfully', 'de' => 'Datei erfolgreich gelöscht'],
    'file_not_found' => ['ar' => 'الملف غير موجود', 'en' => 'File not found', 'de' => 'Datei nicht gefunden'],
    'file_name_required' => ['ar' => 'اسم الملف مطلوب', 'en' => 'File name is required', 'de' => 'Dateiname ist erforderlich'],
    'file_required' => ['ar' => 'يجب اختيار ملف', 'en' => 'A file must be selected', 'de' => 'Eine Datei muss ausgewählt werden'],
    'file_duplicate' => ['ar' => 'يوجد ملف بنفس الاسم والسنة والقسم', 'en' => 'A file with the same name, year and department already exists', 'de' => 'Eine Datei mit demselben Namen, Jahr und Abteilung existiert bereits'],
